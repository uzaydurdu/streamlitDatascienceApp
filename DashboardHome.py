...
if action == "Connect to my database":
    ...
    with db_placeholder.container():
        ...
        with col2:
            db_action = st.selectbox("Choose your database:", ["SQLite", "PostgreSQL", "MySQL"])
        ...
        if db_action == "SQLite":
            ...
            st.write("You selected SQLite. Implement the connection code here.")
            ...
            st.write("You selected MySQL. Implement the connection code here.")
